...
\textbf{Notes:}
\begin{itemize}
    \item \texttt{RAGContextService.assemble\_context} collects chunk-level results, enriches them with entity and scene metadata, and returns a compact context mapping suitable for prompt building (see \texttt{\seqsplit{backend/app/services/rag\_context\_service.py}}).
