...
This chapter presents the background, existing solutions, problem statement, scope, project modules, and work division that ground the implemented system.
...
CoWriteIA addresses these problems through an intelligent system that continuously indexes project content, retrieves relevant context, and assists writers in generating text aligned with their established narrative and style. By maintaining a unified knowledge base and supporting character consistency, scene management, dialogue generation, and semantic search, the system reduces cognitive overhead and improves creative flow.

\section{Scope}

The scope of \textbf{CoWriteIA} covers an intelligent, AI-driven writing environment designed to support long-form creative and research-oriented projects. The system focuses on project-level understanding, semantic reasoning, and context-aware assistance to help writers maintain consistency, creativity, and workflow continuity.
...
The project is organized into several modules, each responsible for a specific part of the writing workflow.
...
This module provides intelligent writing suggestions aligned with the user's tone and project context~\cite{lewis2020rag}.
\begin{enumerate}
...
This module generates natural, character-consistent dialogue suggestions.
\begin{enumerate}
...
This module retrieves factual data from external sources for realistic writing.
\begin{enumerate}
...
This module allows users to ask natural-language questions about their own project.
\begin{enumerate}
...
This module analyzes draft content to find missing or weak areas.
\begin{enumerate}
    \item Identifies incomplete sections.
    \item Suggests improvements for clarity and consistency.
\end{enumerate}

Collectively, these seven modules are implemented and integrated in CoWriteIA, providing a unified workflow for planning, writing, retrieval, assistance, and quality improvement.

\clearpage

\section{Work Division}

Development work was carried out across four major iterations.
...
\subsection*{Iteration III Tasks}

\begin{table}[!ht]
\centering
\caption{Work Division for Iteration III}
\begin{tabular}{lccc}
\toprule
\textbf{Task} & \textbf{Ayesha} & \textbf{Junaid} & \textbf{Aisha} \\
\midrule
Character Repository & \checkmark &  &  \\
Research Integration Agent &  & & \checkmark  \\
Dialogue Generation &  & \checkmark &  \\
Detailed Testing & \checkmark & \checkmark & \checkmark \\
UI Update & \checkmark & \checkmark & \checkmark \\
\bottomrule
\end{tabular}
\end{table}
\FloatBarrier

\subsection*{Iteration IV Tasks}

\begin{table}[!ht]
\centering
\caption{Work Division for Iteration IV}
\begin{tabular}{lccc}
\toprule
\textbf{Task} & \textbf{Ayesha} & \textbf{Junaid} & \textbf{Aisha} \\
\midrule
Final System Deployment & \checkmark & \checkmark & \checkmark \\
Regression Testing & \checkmark & \checkmark & \checkmark \\
Performance Optimization & \checkmark & \checkmark & \checkmark \\
Final Thesis Documentation & \checkmark & \checkmark & \checkmark \\
Project Presentation/Demo Prep & \checkmark & \checkmark & \checkmark \\
\bottomrule
\end{tabular}
\end{table}
\FloatBarrier
